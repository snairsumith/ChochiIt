...
<table width="567" >
  <tr>
    <td width="89">Project Tittles</td>
    <td width="228"><input name="ptittle2" type="text"/></td>
  </tr>
  <tr>
    <td>Project Description</td>
    <td><input name="pdescription" type="text"/></td>
  </tr>
  <tr>
    <td>ProjectModules</td>
    <td><input name="pmodules" type="text"/></td>
  </tr>
  <tr>
    <td>Technologies</td>
    <td><select name="technologies">
  ...
  <tr>
    <td height="47"> Abstract</td>
    <td><label for="abst"></label>
      <input type="file" name="abst" id="abst" /></td>
  </tr>
  <tr>
    <td height="45">Project Source and Database</td>
    <td><label for="psandpd"></label>
      <input type="file" name="psandpd" id="psandpd" /></td>
  </tr>
  <tr>
    <td height="45"></td>
