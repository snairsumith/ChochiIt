...
<nav>
       ...
       <?php $id=$_REQUEST['id']; 
				include("admin.php");
				$db=new admin;
				$res=$db->SelectSeminar($id);
				$row=mysql_fetch_array($res);
				
				
				?>
           
           <form method="post" action="UpdateSeminar.php?id=<?php echo $row['semId']; ?>" id="form1">
    ...
    <table class="auto-style1">
        <tr>
            <td style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: xx-large; color: #E63900" class="auto-style4">Edit Seminar Details</td>
            ...
            <td>
                <table class="auto-style1">
                    ...
                    <tr>
                        ...
                        <td style="padding-top: 5px; padding-bottom: 5px">&nbsp;<input name="TextTitle" type="text" id="ContentPlaceHolder1_TextBox1" class="txts" value="<?php echo $row['semTitle']; ?>" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="padding-top: 5px; padding-bottom: 5px"><span class="auto-style2" style="padding-top: 5px; padding-bottom: 5px">
                          <textarea name="textDes" id="ContentPlaceHolder1_TextBox7" class="txts" ><?php echo $row['semDesc']; ?></textarea>
                        </span></td>
                    </tr>
                    <tr>
                        ...
                        <td class="auto-style2" style="padding-top: 5px; padding-bottom: 5px">
                            <input name="TextTech" type="textTech" id="ContentPlaceHolder1_TextBox2" class="txts" value="<?php echo $row['tec']; ?>" />
                        </td>
                    </tr>
                    <tr>
                        <td style="padding-top: 5px; padding-bottom: 5px">Amount</td>
                        <td style="padding-top: 5px; padding-bottom: 5px">
                            <input name="TextAmount" type="text" id="ContentPlaceHolder1_TextBox5" class="txts" value="<?php echo $row['amount']; ?>" />
                        </td>
                    </tr>
                    <tr>
