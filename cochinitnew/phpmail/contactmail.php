...
include("class.smtp.php");
 ...
 if($manage=="Contacts") {
	...
	<div style="margin-bottom:5px;"><div style="float:left; width:100px; margin-right:10px;">Last Name</div><div style="float:left; margin-right:5px;">:</div> <div>' . $lname . '</div></div><div style="clear:both;"></div>
	...
	<div style="margin-bottom:5px;"><div style="float:left; width:100px; margin-right:10px;">Interested in</div><div style="float:left; margin-right:5px;">:</div> <div>' . $interested . '</div></div><div style="clear:both;"></div>
	<div style="margin-bottom:5px;"><div style="float:left; width:100px; margin-right:10px;">Need details on</div><div style="float:left; margin-right:5px;">:</div> <div>' . $details . '</div></div><div style="clear:both;"></div>';
	...
	$mail->AddBCC('info@ipcsautomation.com');
	/*
	if(!$mail->Send()) {
