...
include("class.smtp.php");
 ...
 $type = $_POST['register'];
 if($type == 1) {
	 $subject ="mail@ipcsautomation.com" . $from; // $_POST['subject'];
 } else {
 ...
 <div style="margin-bottom:5px;"><div style="float:left; width:100px; margin-right:10px;">Training Selected</div><div style="float:left; margin-right:5px;">:</div> <div>' . $training . '</div></div><div style="clear:both;"></div>
 <div style="margin-bottom:5px;"><div style="float:left; width:100px; margin-right:10px;">Message</div><div style="float:left; margin-right:5px;">:</div> <div>' . nl2br($message) . '</div></div><div style="clear:both;"></div>
 ';
...
$mail->AddAddress($to, "mail@ipcsautomation.com");
...
$location='../success_reg.html?msg=4';
