...
<nav>
       ...
       <?php $id=$_REQUEST['id']; 
				include("admin.php");
				$db=new admin;
				$res=$db->SelectPrdt($id);
				$row=mysql_fetch_array($res);
				
				
				?>
           
           <form method="post" action="UpdateProduct.php?id=<?php echo $row['prdtId']; ?>" id="form1">
    ...
    <table class="auto-style1">
        <tr>
            <td style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: xx-large; color: #E63900" class="auto-style4">Edit Product Details</td>
            ...
            <td>
                <table class="auto-style1">
                    ...
                    <tr>
                        ...
                        <td style="padding-top: 5px; padding-bottom: 5px">&nbsp;<input name="TextTitle" type="text" id="ContentPlaceHolder1_TextBox1" class="txts" value="<?php echo $row['PrdtName']; ?>" />
                        </td>
                    </tr>
                    <tr>
                        <td style="padding-top: 5px; padding-bottom: 5px">Description</td>
                        <td style="padding-top: 5px; padding-bottom: 5px"><span class="auto-style2" style="padding-top: 5px; padding-bottom: 5px">
                          <textarea name="textDes" id="ContentPlaceHolder1_TextBox7" class="txts" ><?php echo $row['PrdtDesc']; ?></textarea>
                        </span></td>
                    </tr>
                    <tr>
                        <td class="auto-style2" style="padding-top: 5px; padding-bottom: 5px">Date</td>
                        <td class="auto-style2" style="padding-top: 5px; padding-bottom: 5px">
                            <input name="TextDate" type="textTech" id="ContentPlaceHolder1_TextBox2" class="txts" value="<?php echo $row['PrdtDate']; ?>" />
                        </td>
                    </tr>
                    <tr>
                        <td style="padding-top: 5px; padding-bottom: 5px">Amount</td>
                        <td style="padding-top: 5px; padding-bottom: 5px">
                            <input name="TextAmount" type="text" id="ContentPlaceHolder1_TextBox5" class="txts" value="<?php echo $row['PrdtAmnt']; ?>" />
                        </td>
                    </tr>
                    <tr>
